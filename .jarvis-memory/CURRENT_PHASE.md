...
| 18 | Capital-tier enforcement — closes a real gap: `capital_tier` was purely decorative, nothing stopped a new strategy's signals from executing at full weight | queued (this branch, stacked on #90 + merged #88) |
